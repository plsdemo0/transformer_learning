...
- [ ] **Задача 6: Scaled Dot-Product Attention с нуля (веха №4)**
...
- [ ] **Задача 7: Multi-Head Attention (веха №5)**
...
- [ ] **Задача 8: Позиционные кодирования (веха №6)**
...
- [ ] **Задача 9: Transformer Encoder (веха №7)**
...
- [ ] **Задача 10: Transformer Decoder (веха №8)**
...
- [ ] **Задача 11: Полный Transformer — Encoder-Decoder (веха №9)**
...
- [ ] **Задача 12: Обучение трансформера (веха №10)**
...
- [ ] **Задача 13: BERT — Masked Language Model (веха №11)**
...
- [ ] **Задача 14: GPT — Causal Language Model (веха №12)**
...
- [ ] **Задача 15: Визуализация внимания (веха №13)**
...
- [ ] **Задача 16: HuggingFace Transformers (веха №14)**
...
- [ ] **Задача 17: Финальный ноутбук (веха №15)**
...
- [ ] **Задача 18: Обновление README и requirements.txt**
...
- [ ] **Задача 19: Проверка документации (docs checkpoint)**
