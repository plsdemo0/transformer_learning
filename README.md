...
> 🎭 Каждый ноутбук открывается мемом по теме — потому что учиться должно быть весело.
...
> **Для Apple Silicon (MPS):** при возникновении ошибок установите `PYTORCH_ENABLE_MPS_FALLBACK=1`
